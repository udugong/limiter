...
//
//	mockgen -source=./queue.go -package=queuemocks -destination=../mocks/queuemocks/queue.mock.go BoundedQueue
//
...
func (mr *MockBoundedQueueMockRecorder) Enqueue(val any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
